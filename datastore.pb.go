...
type ReadRequest struct {
	...
	// The page cursor is an opaque string value returned from a previous call to to
	// `ReadData` that can be used to control from where pagination should
	// continue from. This field is optional.
